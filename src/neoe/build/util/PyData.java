...
public class PyData {
	...
	public static void main(String[] args) throws Exception {
		...
		// System.out.println("reading file:" + new
		// File(args[0]).getAbsolutePath());
		// Object o = PyData.parseAll(FileUtil.readString(new
		// FileInputStream(args[0]), "utf8"), false);
	...
	// return parseAll(FileUtil.readString(new FileInputStream(fn), null),
	// false);
	// }
